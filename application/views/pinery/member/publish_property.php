...
<!-- 百度 baidu start-->
<!-- 城市下拉列表 -->
<div id="baidumap" class="fl clearfix mb15 pl15" style="width:660px;">
    <?php
    echo html_select(array('options'=>array('北京','河北省'),'name'=>'province','class'=>'select'));
    echo html_select(array('options'=>array('涿州','固安'),'name'=>'city','class'=>'select'));
    ?>
    <span id="bdAddress"></span>
    <input type="hidden" name="bdPoint" id="bdPoint"/>
</div>        
<!-- 百度地图 -->
<div class="ml20 pl5">
