...
<div class="member-body">
    ...
    <div class="member-content">
        ...
        $colspan = 6;
        if(empty($listData)){
            $th = html_th(array('colspan'=>$colspan,'body'=>"没有数据,去".html_a(array('text'=>'发布信息','href'=>base_url('member/publish/car')))));
            ...
            foreach ($listData as $key => $value) {
                    ...
                    $td .= html_td(array('body'=>html_a(array('text'=>$value['title'],'href'=>base_url('car/detail/?id='.$car_id.$value['id']),'target'=>"_blank")),'align'=>'center'));
                    $td .= html_td(array('body'=>$dataCar['type'][$value['type']]['name'],'align'=>'center'));
